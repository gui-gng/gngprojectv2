...
const ExperienceNav = () => (
    <div className="h-100 w-100 pt-3 row m-0 justify-content-center experienceNav">
        <NavLink className="nav-link p-0" to="/experience/cast" activeClassName="is-active">
            <div className="col p-3 bg-red itemExperience  h-100">
                <div className="pt-3 align-self-center bg-light text-center rounded">
                    <img src="/images/logoCast.png" height="60px" />
        ...
        <NavLink className="nav-link p-0" to="/experience/ericsson" activeClassName="is-active">
            <div className="col p-3 bg-darkblue itemExperience h-100">
                <div className="pt-3 align-self-center bg-light text-center rounded">
                    <img src="/images/logoEricsson.png" height="60px" />
        ...
        <NavLink className="nav-link p-0" to="/experience/nordica" activeClassName="is-active">
            <div className="col p-3 bg-green itemExperience h-100">
                <div className="pt-3 align-self-center bg-light text-center rounded">
                    <img src="/images/logoNordica.png" height="60px" />
        ...
        <NavLink className="nav-link p-0" to="/experience/netaware" activeClassName="is-active">
